...
import { uploadFiles, GetAttachment } from "../../../services/upload";
 ...
 * @param {string}   props.module       - "ordenes-trabajo" | "solicitudes"
 * @param {string}   props.referencesId    - _id del documento padre
 * @param {string}   props.category    - "evidencias" | "firmas" | "adjuntos"
...
export default function FileUploadZone({
    ...
    const handleFiles = useCallback(async (fileList) => {
        ...
        try {
            setUploading(true);
            const uploaded = await uploadFiles({ module, referencesId, category, files: arr });
    ...
    }, [files, module, referencesId, category, onUploaded]);
